...
public class MetricService {
    ...
    public Metric createMetric(String name, String baseUnit, Long measurementTypeId,
            com.devlife4me.projectvital.model.enums.MetricDataType dataType) {
        ...
        Metric metric = Metric.builder()
                ...
                .dataType(dataType != null ? dataType : com.devlife4me.projectvital.model.enums.MetricDataType.NUMERIC)
                .build();
